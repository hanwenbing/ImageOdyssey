...
![例 178：亚马逊详情图设计](assets/case178.jpg)
...
![例 185：武则天发微博自拍太魔性了](assets/case185.jpg)
...
![例 188：暗黑极简头像网站视觉设计](assets/case188.jpg)
...
![例 201：三甲医院真实门诊处方笺](assets/case201.jpg)
...
![例 203：杠精视角的独特文案创意](assets/case203.jpg)
...
![例 205：皇宫深处的御用快递驿站](assets/case205.jpg)
...
![例 209：神话三国枪战世界](assets/case209.jpg)
...
![例 210：萌系大模型训练图解](assets/case210.jpg)
...
![例 214：绘制金瓶梅知识图谱](assets/case214.jpg)
...
![例 225：大师级真迹复刻](assets/case225.jpg)
...
![例 232：兰亭集序书法帖意境图](assets/case232.jpg)
...
![例 233：蒙娜丽莎畅饮可乐的趣味油画](assets/case233.jpg)
...
![例 245：马斯克专属篆刻印章设计](assets/case245.jpg)
...
![例 246：黑白线稿勾勒的上海风情](assets/case246.jpg)
...
![例 248：景德镇青花瓷全景解说图谱](assets/case248.jpg)
...
![例 250：小王子与星舰的浪漫联名](assets/case250.jpg)
...
![例 251：言叶之庭春雨绿意单日历](assets/case251.jpg)
...
![例 252：五一劳动节手举牌创意设计集](assets/case252.jpg)
...
![例 265：日式潮流广告四联画](assets/case265.jpg)
...
![例 268：威化岛回军前夕李成桂动态](assets/case268.jpg)
...
![例 273：橙红渐变中的孤独剪影](assets/case273.jpg)
...
![例 281：赛博朋克科幻曼荼罗](assets/case281.jpg)
...
![例 295：复古传统老黄历二零二六年四月十八](assets/case295.jpg)
...
![例 326：红蓝撞色高跟诱惑](assets/case326.jpg)

**提示词：**

```text
整体采用8K、超高清晰度、2:3画幅，AI编辑感、高细节3D渲染，柔和影棚光与逼真阴影，极致清晰、锐利边缘，无噪点、无压缩。模块1：一位风格化3D卡通女性，站立姿势，身体微微侧转，一手抬起食指触唇，灿烂微笑、大眼睛；黑色双辫马尾，戴绿色帽子；大而圆的深色瞳孔，光滑、哑光、风格化纹理的皮肤；穿无袖绿色短款上衣、宽松绿色束脚运动裤配抽绳、白色运动鞋；配绿色硬壳拉杆行李箱；配色为多种绿色和白色点缀；背景是纯绿色，带柔软、微颗粒的影棚质感；全身平视，主体与背景锐利分离。模块2：另一位风格化3D卡通女性，微微后仰靠在背景上，俏皮、嘴唇轻撅、眼睛斜视；棕色短发、凌乱，红色太阳镜架在头顶；穿贴身蓝色罗纹吊带裙和红色高跟凉鞋配蝴蝶结；配色为大胆红色与深蓝；背景是纯红色、光滑哑光表面；一侧柔和定向光在红色背景上投下清晰影子；全身构图，强调弯曲身姿和交叉双腿。模块3：两位风格化3D卡通角色，左侧女性包裹在红色纹理毯子中，表情平静、浅笑、眼睛向上看；右侧男性包裹在橙色纹理毯子中，表情中性、目光温柔向上。环境里有红色沙发和红色地面，背景为深红色、织物状横向纹理；女性赤脚、男性穿袜子，毯子是厚实针织面料；居中中景宽镜头，左右平衡构图，主体与背景锐利分离。
```
...
![例 334：RAG 技术详解图](assets/case334.jpg)
